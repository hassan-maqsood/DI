...
<div class="page-title">
    <div class="container">
        <h1>Shop Boxed Left Sidebar</h1>
        <ul class="breadcrumbs">
            <li><a href="index.html">Home</a>
            </li>
            <li class="separator">&nbsp;/&nbsp;</li>
            <li>Shop Boxed Left Sidebar</li>
        </ul>
    </div>
</div>
<!-- Page Content-->
<div class="container padding-bottom-3x mb-1">
    <div class="row">
        ...
        <div class="col-lg-9 col-md-8 order-md-2">
            ...
            <div class="row mb-2">
                <!-- Item-->
                @if (count((array)$machines) > 0)
                @foreach($machines as $machine)
                <div class="col-sm-12">
                    <div class="product-card mb-30">
                        <div class="product-card-thumb"> <a class="product-card-link" href="shop-single.html"></a><img src="img/hero-slider/m1.png" alt="Product">
                        ...
                        <div class="product-card-details">
                            <h3 class="product-card-title"><a href="shop-single.html">{{$machine->manufacturer}} / {{$machine->series}} / {{$machine->model}}</a></h3>
                            <h4>Max X/Y/X Axis Travel: {{$machine->max_x_axis_travel}} / {{$machine->max_y_axis_travel}} / {{$machine->max_z_axis_travel}}</h4>
                            <h4 class="product-card-price">Spindel Speed: {{$machine->spindel_speed}}</h4>
                        </div>
                    </div>
                </div>
                @endforeach
