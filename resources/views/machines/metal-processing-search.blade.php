    ...
    <nav class="site-menu">
        <ul>
            <li><a href="index.html"><span>Home</span></a>
                <ul class="sub-menu">
                    <li class="has-children"><a href="index.html"><span>Hero Slider</span></a>
            ...
            <li class="active"><a href="shop-boxed-ls.html"><span>Shop</span></a>
                <ul class="sub-menu">
                    <li><a href="shop-categories.html">Shop Categories</a></li>
                    <li class="active has-children"><a href="shop-boxed-ls.html"><span>Shop Layout</span></a>
                        <ul class="sub-menu">
                            <li class="active"><a href="shop-boxed-ls.html">Boxed Left Sidebar</a></li>
            ...
            <div class="toolbar-section" id="mobileMenu">
                ...
                <nav class="slideable-menu mt-4">
                    <ul class="menu">
                        ...
                        <li class="has-children active"><span><a href="shop-boxed-ls.html"><span>Shop</span></a><span class="sub-menu-toggle"></span></span>
                            <ul class="slideable-submenu">
                                <li><a href="shop-categories.html">Shop Categories</a></li>
                                <li class="active has-children"><span><a href="shop-boxed-ls.html"><span>Shop Layout</span></a><span class="sub-menu-toggle"></span></span>
                                    <ul class="slideable-submenu">
                                        <li class="active"><a href="shop-boxed-ls.html">Boxed Left Sidebar</a></li>
                                        <li><a href="shop-boxed-rs.html">Boxed Right Sidebar</a></li>
                                        <li><a href="shop-boxed-ft.html">Boxed Filters Top</a></li>
...
<div class="container padding-bottom-3x mb-1">
    <div class="row">
        ...
        <div class="col-lg-9 col-md-8 order-md-2">
            <!-- Products Grid-->
            <form id="individual-search" method="post" action="{{url('mp-post-search')}}">
            @csrf
            <div class="row mb-2">
                <div class="col-sm-12">
                    <div class="product-card mb-30">
                        <div class="pb-3">
                            <a class="filters-toggle" href="#filters" data-toggle="filters"><i class="material-icons filter_list"></i> Performance data</a>
                        </div>
                        <div class="filters-wrap">
                            ...
                            <div class="filters-pane pb-3" id="filters">
                                <div class="row">
                                    <div class="col-md-8">
                                        <div class="text-left">
                                            Travel X/Y/Z-axis [mm]
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <!-- Widget Price Range-->
                                        <section class="widget widget-categories">
                                            <div class="price-range-slider" method="post" data-start-min="250" data-start-max="650" data-min="0" data-max="1000" data-step="50">
                                                <div class="ui-range-slider"></div>
                                                <footer class="ui-range-slider-footer">
                                                    <div class="column">
                                                        <div class="ui-range-values">
                                                            <div class="ui-range-value-min"><span></span>
                                                                <input type="hidden" name="performance[travel][min]">
                                                            </div>&nbsp;-&nbsp;
                                                            <div class="ui-range-value-max"><span></span>
                                                                <input type="hidden" name="performance[travel][max]">
                                                            </div>
                                                        </div>
                                                    </div>
                                                </footer>
                                ...
                                <div class="row">
                                    <div class="col-md-8">
                                        <div class="text-left">
                                            Rapid Traverse speed X/Y/Z-axis [m/min]
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <!-- Widget Price Range-->
                                        <section class="widget widget-categories">
                                            <div class="price-range-slider" method="post" data-start-min="250" data-start-max="650" data-min="0" data-max="1000" data-step="1">
                                                <div class="ui-range-slider"></div>
                                                <footer class="ui-range-slider-footer">
                                                    <div class="column">
                                                        <div class="ui-range-values">
                                                            <div class="ui-range-value-min"><span></span>
                                                                <input type="hidden" name="performance[rts][min]">
                                                            </div>&nbsp;-&nbsp;
                                                            <div class="ui-range-value-max"><span></span>
                                                                <input type="hidden" name="performance[rts][max]">
                                                            </div>
                                                        </div>
                                                    </div>
                                                </footer>
                                ...
                                <div class="row">
                                    <div class="col-md-8">
                                        <div class="text-left">
                                            Axis acceleration X/Y/Z-axis [m/sec2]
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <!-- Widget Price Range-->
                                ...
                                <div class="row">
                                    <div class="col-md-8">
                                        <div class="text-left">
                                            Positioning accuracy X/Y/Z-axis [um]
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <!-- Widget Price Range-->
                                ...
                                <div class="row">
                                    <div class="col-md-8">
                                        <div class="text-left">
                                            Turning range A/C axis [1/min]
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <!-- Widget Price Range-->
                                        <section class="widget widget-categories">
                                            <div class="price-range-slider" method="post" data-start-min="250" data-start-max="950" data-min="0" data-max="1000" data-step="50">
                                                <div class="ui-range-slider"></div>
                                                <footer class="ui-range-slider-footer">
                                                    <div class="column">
                                                        <div class="ui-range-values">
                                ...
                                <div class="row">
                                    <div class="col-md-8">
                                        <div class="text-left">
                                            Max Spindle speed [1/min]
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <!-- Widget Price Range-->
                                        <div id="spindle-range-slider"></div>
                                        <div class="ui-range-slider"></div>
                                        <input type="hidden" class="hidden-spindle-speed" name="performance[spindle]" value="">
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="product-card">
                        <div class="pb-3">
                            <a class="filters-toggle" href="#size" data-toggle="filters"><i class="material-icons filter_list"></i> Size / Restrictions</a>
                        </div>
                        <div class="filters-wrap">
                            <!-- Widgets-->
                            <div class="filters-pane" id="size">
                            </div>
                        </div>
                    </div>
                    <div class="product-card">
                        <div class="pb-3">
                            <a class="filters-toggle" href="#price" data-toggle="filters"><i class="material-icons filter_list"></i> Price</a>
                        </div>
                        <div class="filters-wrap">
                            <!-- Widgets-->
                            <div class="filters-pane" id="price">
                            </div>
                        </div>
                    </div>
                    <div class="product-card">
                        <div class="pb-3">
                            <a class="filters-toggle" href="#terms" data-toggle="filters"><i class="material-icons filter_list"></i> Terms & Conditions</a>
                        </div>
                        <div class="filters-wrap">
                            <!-- Widgets-->
                            <div class="filters-pane pb-3" id="terms">
                                <div class="custom-control custom-checkbox form-group">
                                    <input class="custom-control-input" type="checkbox" id="logged" >
                                    <label class="custom-control-label" for="logged">I confirm that I have downloaded and read the initial information of the insurance broker according to § 15
                                        VersVermV and the information according to § 60 Abs. 2 VVG.</label>
                                </div>
                                <div class="custom-control custom-checkbox form-group">
                                    <input class="custom-control-input" type="checkbox" id="logged" >
                                    <label class="custom-control-label" for="logged">I confirm that I have read the broker agreement according to § 15 VersVermV and the information according
                                        to § 60 Abs. </label>
                                </div>
                            </div>
                        </div>
            ...
            <div class="row float-right">
                <div class="column">
                    <button class="btn btn-outline-primary btn-sm" type="submit">Compare Now</button>
                </div>
            </div>
            </form>
            <!-- Pagination-->
