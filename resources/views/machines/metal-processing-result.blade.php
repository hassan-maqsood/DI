            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-12">
                    <div class="product-card mb-30">
                        <div class="product-card-thumb"> <span class="product-badge text-danger">Sale</span><a class="product-card-link" href="shop-single.html"></a><img src="img/hero-slider/m1.png" alt="Product">
                ...
                <div class="col-sm-12">
                    <div class="product-card mb-30">
                        ...
                        <div class="product-card-details">
                            <h3 class="product-card-title"><a href="shop-single.html">{{$machine->model}}</a></h3>
                            <h4 class="product-card-price">{{$machine->spindel_speed}}</h4>
                        </div>
                    </div>
                </div>
                @endforeach
